 ...
 * @return {Object} - this
 */
function _tristerthemeColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_tristerthemeColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_tristerthemeColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_tristerthemeColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _tristerthemeColor object.
 *
 * @since Trister Theme 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function tristerthemeColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _tristerthemeColor( backgroundColor, accentHue );
