<?php
/**
 * A template partial to output pagination for the Trister Theme default theme.
 *
...
$prev_text = sprintf(
	 ...
	 */
	__( 'Newer <span class="nav-short">Posts</span>', 'tristertheme' )
);
$next_text = sprintf(
	 ...
	 * The text inside the span with the class nav-short will be hidden on small screens.
	 */
	__( 'Older <span class="nav-short">Posts</span>', 'tristertheme' ),
