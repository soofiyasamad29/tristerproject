...
if ( ! class_exists( 'tristertheme_Non_Latin_Languages' ) ) {
	/**
	 * Language handling.
	 *
	 * @since Trister Theme 1.0
	 */
	class tristertheme_Non_Latin_Languages {
		...
		public static function get_non_latin_css( $type = 'front-end' ) {
			...
			$font_family = apply_filters(
				'tristertheme_get_localized_font_family_types',
				array(
			...
			$elements = apply_filters(
				'tristertheme_get_localized_font_family_elements',
				array(
			...
			return tristertheme_generate_css( implode( ',', $elements[ $type ] ), 'font-family', implode( ',', $font_family[ $locale ] ), null, null, false );
