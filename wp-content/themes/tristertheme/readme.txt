...
Trister Theme WordPress Theme, Copyright 2019-2022 WordPress.org
Trister Theme is distributed under the terms of the GNU GPL.
...
Trister Theme is derived from the Chaplin Theme, Copyright 2019 Anders Norén
Chaplin Theme is distributed under the terms of the GNU GPL version 2.0

Trister Theme bundles the following third-party resources:
...
Bespoke Icons Created For Trister Theme
License: Creative Commons Zero (CC0), https://creativecommons.org/publicdomain/zero/1.0/
...
- tristertheme_SVG_Icons
- tristertheme_the_theme_svg()
- tristertheme_get_theme_svg()
- tristertheme_nav_menu_social_icons()
